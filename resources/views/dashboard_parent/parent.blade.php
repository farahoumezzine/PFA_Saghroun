...
<head>
    ...
    <link rel="icon"  href="{{ asset('logo/LOGO.jpg')}}" type="image/x-icon"> <!-- Favicon-->
    <link rel="stylesheet" href= "{{asset('dashboard_parent/plugins/bootstrap/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('dashboard_parent/plugins/jvectormap/jquery-jvectormap-2.0.3.min.css')}}"/>
    <link rel="stylesheet" href="{{asset('dashboard_parent/plugins/morrisjs/morris.min.css')}}" />

    <!-- Custom Css -->
    <link rel="stylesheet" href="{{asset('dashboard_parent/css/main.css')}}">
    <link rel="stylesheet" href="{{asset('dashboard_parent/css/color_skins.css')}}">
</head>
...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img class="zmdi-hc-spin" src="{{ asset('logo/LOGO.png')}}" width="150" height="100" alt="saghroun"></div>
    ...
    <ul class="nav navbar-nav navbar-left">
        <li>
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img src="{{ asset('logo/LOGO.png')}}" width="90" alt="Oreo"></a>
            </div>
        </li>
        ...
        <div class="tab-pane stretchRight active" id="dashboard">
            <div class="menu">
                <ul class="list">
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-accounts-outline"></i><span>Children</span> </a>
                        <ul class="ml-menu">
                            <li><a href="students.html">All Children</a></li>
                            <li><a href="{{ route('childForm') }}">Add Children</a></li>
                            <li><a href="students-profile.html">Children Profile</a></li>
                        </ul>
                    </li>
    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                <h2>Dashboard
                    <small>Welcome to Saghroun</small>
                </h2>
            </div>
            <div class="col-lg-7 col-md-7 col-sm-12 text-right">
                ...
                <ul class="breadcrumb float-md-right">
                    <li class="breadcrumb-item"><a href="index.html"><i class="zmdi zmdi-home"></i> Saghroun</a></li>
...
<!-- Jquery Core Js -->
<script src="{{asset('dashboard_parent//bundles/libscripts.bundle.js')}}"></script> <!-- Lib Scripts Plugin Js ( jquery.v3.2.1, Bootstrap4 js) -->
<script src="{{asset('dashboard_parent/bundles/vendorscripts.bundle.js')}}"></script> <!-- slimscroll, waves Scripts Plugin Js -->

<script src="{{asset('dashboard_parent/bundles/morrisscripts.bundle.js')}}"></script><!-- Morris Plugin Js -->
<script src="{{asset('dashboard_parent/bundles/jvectormap.bundle.js')}}"></script> <!-- JVectorMap Plugin Js -->
<script src="{{asset('dashboard_parent/plugins/jvectormap/jquery-jvectormap-us-aea-en.js')}}"></script><!-- USA Map Js -->
<script src="{{asset('dashboard_parent/bundles/knob.bundle.js')}}"></script> <!-- Jquery Knob, Count To, Sparkline Js -->

<script src="{{asset('dashboard_parent/bundles/mainscripts.bundle.js')}}"></script>
<script src="{{asset('dashboard_parent/js/pages/index.js')}}"></script>
</body>
