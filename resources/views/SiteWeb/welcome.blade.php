...
<div class="template-content">
    ...
    <!-- Slider -->
    <div class="template-content-section template-content-section-page-home template-padding-reset">
        ...
        <div id="rev_slider_1_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" style="margin:0px auto;background-color:#FAF4E7;padding:0px;margin-top:0px;margin-bottom:0px;">
            ...
            <div id="rev_slider_1_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.1.6">
                ...
                <ul>
                    ...
                    <li data-index="rs-1" data-transition="fade" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="media/image/_sample/slider/slider_slide1_background-100x50.png" data-rotate="0" data-saveperformance="off" class="fable_slide_1_class" id="fable_slide_1_id" data-title="fable_slide_1" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">

                        <img src="{{asset('siteweb/media/image/_sample/slider/slider_slide1_background.png')}}" alt="" width="100" height="600" data-bgposition="center top" data-bgfit="contain" data-bgrepeat="repeat-x" class="rev-slidebg" data-no-retina>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             style="z-index:5;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_slide1_img1.png')}}" alt="" width="580" height="491" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:6;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_slide1_img2.png')}}" alt="" width="567" height="546" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-font-lato-black tp-resizeme"
                             ...
                             style="z-index:8;white-space:nowrap;border-color:rgba(86,80,159,1.00);">Perfect Education
                        </div>
                        ...
                        <div class="tp-caption tp-font-lato-light tp-resizeme"
                             ...
                             data-elementdelay="0.1"
                             data-endelementdelay="0.1"
                             style="z-index:9;white-space:nowrap;border-color:rgba(86,80,159,1.00);">For Your Child
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:11;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_icon1.png')}}" alt="" width="98" height="100" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:12;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_icon2.png')}}" alt="" width="88" height="87" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:13;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_icon3.png')}}" alt="" width="92" height="91" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:14;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_icon4.png')}}" alt="" width="74" height="85" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:15;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_icon7.png')}}" alt="" width="73" height="81" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:16;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_icon6.png')}}" alt="" width="86" height="77" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:17;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_icon5.png')}}" alt="" width="99" height="98" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:18;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_icon8.png')}}" alt="" width="86" height="85" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:19;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_icon9.png')}}" alt="" width="74" height="91" data-no-retina>
                        </div>

                    </li>

                    <!-- SLIDE -->
                    <li data-index="rs-4" data-transition="fade" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="media/image/_sample/slider/slider_slide2_background-100x50.png" data-rotate="0" data-saveperformance="off" class="fable_slide_2_class" id="fable_slide_2_id" data-title="fable_slide_2" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">

                        <img src="{{asset('siteweb/media/image/_sample/slider/slider_slide2_background.png')}}" alt="" width="100" height="600" data-bgposition="center top" data-bgfit="contain" data-bgrepeat="repeat-x" class="rev-slidebg" data-no-retina>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:5;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_slide2_img2.png')}}" alt="" width="453" height="458" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:6;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_slide1_img2.png')}}" alt="" width="465" height="537" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-font-handlee tp-resizeme"
                             ...
                             data-splitout="none"
                             data-responsive_offset="on"
                             style="z-index:7;white-space:nowrap;color:rgba(254,101,0,1.00);border-color:rgba(86,80,159,1.00);">Friendly Atmosphere
                        </div>
                        ...
                        <div class="tp-caption tp-font-lato-black tp-resizeme"
                             ...
                             data-elementdelay="0.1"
                             data-endelementdelay="0.1"
                             style="z-index:8;white-space:nowrap;border-color:rgba(86,80,159,1.00);">Welcoming Place
                        </div>
                        ...
                        <div class="tp-caption tp-font-lato-light tp-resizeme"
                             ...
                             data-elementdelay="0.1"
                             data-endelementdelay="0.1"
                             style="z-index:9;white-space:nowrap;border-color:rgba(86,80,159,1.00);">For Every Child
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:11;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_icon13.png')}}" alt="" width="83" height="93" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:12;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_icon12.png')}}" alt="" width="89" height="78" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:13;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_icon11.png')}}" alt="" width="81" height="82" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:14;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_icon14.png')}}" alt="" width="61" height="43" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:15;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_icon10.png')}}" alt="" width="79" height="84" data-no-retina>
                        </div>

                    </li>

                    <li data-index="rs-5" data-transition="fade" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="media/image/_sample/slider/slider_slide3_background-100x50.png" data-rotate="0" data-saveperformance="off" class="fable_slide_3_class" id="fable_slide_3_id" data-title="fable_slide_3" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">

                        <img src="{{asset('siteweb/media/image/_sample/slider/slider_slide3_background.png')}}" alt="" width="100" height="600" data-bgposition="center top" data-bgfit="contain" data-bgrepeat="repeat-x" class="rev-slidebg" data-no-retina>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:5;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_slide3_img1.png')}}" alt="" width="607" height="442" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:6;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_slide3_img2.png')}}" alt="" width="254" height="157" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:7;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_slide3_img3.png')}}" alt="" width="172" height="97" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-font-handlee tp-resizeme"
                             ...
                             data-splitout="none"
                             data-responsive_offset="on"
                             style="z-index:8;white-space:nowrap;color:rgba(254,101,0,1.00);border-color:rgba(86,80,159,1.00);">Learning & Fun
                        </div>
                        ...
                        <div class="tp-caption tp-font-lato-black tp-resizeme"
                             ...
                             data-elementdelay="0.1"
                             data-endelementdelay="0.1"
                             style="z-index:9;white-space:nowrap;border-color:rgba(86,80,159,1.00);">Learning Program
                        </div>
                        ...
                        <div class="tp-caption tp-font-lato-light tp-resizeme"
                             ...
                             data-elementdelay="0.1"
                             data-endelementdelay="0.1"
                             style="z-index:10;white-space:nowrap;border-color:rgba(86,80,159,1.00);">& After-School Care
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:12;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_icon15.png')}}" alt="" width="87" height="84" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:13;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_icon16.png')}}" alt="" width="79" height="84" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:15;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_icon17.png')}}" alt="" width="65" height="73" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-responsive_offset="on"
                             style="z-index:16;">
                            <img src="{{asset('siteweb/media/image/_sample/slider/slider_icon18.png')}}" alt="" width="78" height="76" data-no-retina>
                        </div>
    ...
    <!-- Section -->
    <div class="template-content-section template-content-section-page-home template-padding-reset template-background-image">
            ...
            <div class="template-component-call-to-action template-component-call-to-action-style-2 template-section-white">
                <div class="template-component-call-to-action-content">
                    ...
                    <div class="template-component-call-to-action-content-right">
                        <a href="#" class="template-component-button template-component-button-style-2 template-section-white">Learn more<i></i></a>
                    </div>
                </div>
            </div>
    ...
    <!-- Section -->
    <div class="template-content-section template-content-section-page-about template-padding-top-reset template-padding-bottom-5">
            ...
            <div class="template-component-feature template-component-feature-style-4 template-component-feature-position-top template-component-feature-size-large">
                <ul class="template-layout-25x25x25x25 template-clear-fix">
                    <li class="template-layout-column-left">
                        <div class="template-icon-feature template-icon-feature-name-schoolbag-alt"></div>
                        <h5>Morbi Etos</h5>
                        <p>Praesent interdum est gravida vehicula est node maecenas loareet morbi a dosis luctus novum est praesent.</p>
                    </li>
                    <li class="template-layout-column-center-left">
                        <div class="template-icon-feature template-icon-feature-name-stroller-alt"></div>
    ...
    <!-- Section -->
    <div class="template-content-section template-content-section-page-about template-padding-bottom-5 template-background-color-2">
                ...
                <div class="template-layout-column-left">
                    ...
                    <div class="template-component-tab">
                        <ul class="template-align-left">
                            <li>
                                <a href="#template-tab-1">Overview</a>
                                <span></span>
                            </li>
                            <li>
                                <a href="#template-tab-2">Our Mission</a>
                                <span></span>
                            </li>
                        </ul>
    ...
    <!-- Section -->
    <div class="template-content-section template-content-section-page-about template-background-image template-background-image-1">
    ...
    <!-- Section -->
    <div class="template-content-section template-content-section-page-classes template-padding-top-reset template-padding-bottom-5">
    ...
    <!-- Section -->
    <div class="template-content-section template-content-section-page-classes template-padding-bottom-5 template-background-color-2">
            ...
            <ul class="template-layout-25x25x25x25 template-layout-margin-reset template-clear-fix">
                ...
                <li class="template-layout-column-left">
                    ...
                    <div class="template-component-image template-fancybox template-preloader">
                        <a href="{{asset('siteweb/media/image/_sample/1050x770/5.jpg')}}" data-fancybox-group="gallery-1">
                            <img src="{{asset('siteweb/media/image/_sample/1050x770/5.jpg')}}" alt="" />
                ...
                <li class="template-layout-column-center-left">
                    <div class="template-component-image template-fancybox template-preloader">
                        <a href="{{asset('siteweb/media/image/_sample/1050x770/6.jpg')}}" data-fancybox-group="gallery-1">
                            <img src="{{asset('siteweb/media/image/_sample/1050x770/6.jpg')}}" alt="" />
                            <span><span><span></span></span></span>
                        </a>
                    </div>
                </li>
                ...
                <li class="template-layout-column-center-right">
                    <div class="template-component-image template-fancybox template-preloader">
                        <a href="{{asset('siteweb/media/image/_sample/1050x770/7.jpg')}}" data-fancybox-group="gallery-1">
                            <img src="{{asset('siteweb/media/image/_sample/1050x770/7.jpg')}}" alt="" />
                            <span><span><span></span></span></span>
                        </a>
                    </div>
                </li>
                ...
                <li class="template-layout-column-right">
                    <div class="template-component-image template-fancybox template-preloader">
                        <a href="{{asset('siteweb/media/image/_sample/1050x770/1.jpg')}}" data-fancybox-group="gallery-1">
                            <img src="{{asset('siteweb/media/image/_sample/1050x770/1.jpg')}}" alt="" />
                            <span><span><span></span></span></span>
                        </a>
                    </div>
                </li>
    ...
    <div class="template-content-section template-content-section-page-classes template-padding-reset template-background-image">
        ...
        <div class="template-main">
            <div class="template-component-call-to-action template-component-call-to-action-style-2 template-section-white">
                <div class="template-component-call-to-action-content">
                    <div class="template-component-call-to-action-content-left">
                        <h3>See Our Kindergarten Photo Gallery!</h3>
                    </div>
                    <div class="template-component-call-to-action-content-right">
                        <a href="#" class="template-component-button template-component-button-style-2 template-section-white">View Gallery<i></i></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Section -->
    <div class="template-content-section template-content-section-page-teachers template-padding-top-reset template-padding-bottom-5">
                ...
                <ul class="template-layout-50x50 template-clear-fix">
                        ...
                        <ul class="template-layout-50x50 template-clear-fix">
                            <li class="template-layout-column-left">
                                <div class="template-component-image template-component-image-hover-slide-enable template-fancybox template-preloader">
                                    <a href="{{asset('siteweb/media/image/_sample/525x560/11.jpg')}}" data-fancybox-group="team-2">
                    ...
                    <li class="template-layout-column-right">
                        <ul class="template-layout-50x50 template-clear-fix">
                            <li class="template-layout-column-left">
                                <div class="template-component-image template-component-image-hover-slide-enable template-fancybox template-preloader">
                                    <a href="{{asset('siteweb/media/image/_sample/525x560/2.jpg')}}" data-fancybox-group="team-2">
                                        <img src="{{asset('siteweb/media/image/_sample/525x560/2.jpg')}}" alt="" />
                                        <span><span><span></span></span></span>
                                    </a>
                                    <div>
                    ...
                    <li class="template-layout-column-left">
                        <ul class="template-layout-50x50 template-clear-fix">
                            <li class="template-layout-column-left">
                                <div class="template-component-image template-component-image-hover-slide-enable template-fancybox template-preloader">
                                    <a href="{{asset('siteweb/media/image/_sample/525x560/12.jpg')}}" data-fancybox-group="team-2">
                                        <img src="{{asset('siteweb/media/image/_sample/525x560/12.jpg')}}" alt="" />
                                        <span><span><span></span></span></span>
                                    </a>
                                    <div>
                    ...
                    <li class="template-layout-column-right">
                        <ul class="template-layout-50x50 template-clear-fix">
                            <li class="template-layout-column-left">
                                <div class="template-component-image template-component-image-hover-slide-enable template-fancybox template-preloader">
                                    <a href="{{asset('siteweb/media/image/_sample/525x560/13.jpg')}}" data-fancybox-group="team-2">
                                        <img src="{{asset('siteweb/media/image/_sample/525x560/13.jpg')}}" alt="" />
                                        <span><span><span></span></span></span>
                                    </a>
                                    <div>
                                        <h6>Angela Lynn</h6>
    ...
    <!-- Section -->
    <div class="template-content-section template-content-section-page-teachers template-background-image template-background-image-3">
            ...
            <div class="template-section-white">
                <div class="template-component-testimonial template-component-testimonial-style-2">
                    <ul class="template-layout-100">
                        ...
                        <li class="template-layout-column-left">
                            <i></i>
                            <p>I have to say that I have 2 children ages 5 and 2 and have used various daycareâ€™s in Kindergartens and this is by far the very best I have ever used.</p>
                            <div></div>
    ...
    <div class="template-content-section template-content-section-page-blog template-padding-top-reset">
        ...
        <div class="template-main">
                ...
                <ul class="template-layout-33x33x33 template-clear-fix">
                    ...
                    <li class="template-layout-column-left">
                        ...
                        <div class="template-component-image template-preloader">
                            <a href="#">
                                <img src="{{asset('siteweb/media/image/_sample/690x414/7.jpg')}}" alt=""/>
                                <span><span><span></span></span></span>
                            </a>
                    ...
                    <li class="template-layout-column-center">
                        ...
                        <div class="template-component-image template-preloader">
                            <a href="#">
                                <img src="{{asset('siteweb/media/image/_sample/690x414/2.jpg')}}" alt=""/>
                                <span><span><span></span></span></span>
                            </a>
                    ...
                    <li class="template-layout-column-right">
                        ...
                        <div class="template-component-image template-preloader">
                            <a href="#">
                                <img src="{{asset('siteweb/media/image/_sample/690x414/9.jpg')}}" alt=""/>
                                <span><span><span></span></span></span>
                            </a>
                            <div class="template-component-recent-post-comment-count">4</div>
                        </div>
            ...
            <div class="template-align-center">
                <a href="#" class="template-component-button template-component-button-style-1">Go To Blog<i></i></a>
            </div>
    ...
    <!-- Section -->
    <div class="template-content-section template-content-section-page-contact template-padding-reset">
    ...
    <!-- Section -->
    <div class="template-content-section template-content-section-page-contact template-padding-top-reset">
        ...
        <div class="template-main">
            ...
            <div class="template-component-header-subheader">
                <h2>Contact Us</h2>
                <h6>Our postal address and contact details</h6>
                <div></div>
            </div>
                ...
                <ul class="template-layout-33x33x33 template-clear-fix">
                    ...
                    <li class="template-layout-column-center">
                        ...
                        <p>
                            ...
                            Fax: 1-800-64-39<br/>
                            <a href="https://quanticalabs.com/cdn-cgi/l/email-protection#c3aca5a5aaa0a683a5a2a1afa6eda0acae"><span class="__cf_email__" data-cfemail="aac5ccccc3c9cfeacccbc8c6cf84c9c5c7">[email&#160;protected]</span></a>
                        </p>
                    </li>
                    ...
                    <div>
                        <div class="template-widget-recent-post template-widget-recent-post-style-1">
                            <ul>
                                ...
                                <li>
                                    <a href={{asset('index14e9.html?page=post-image')}}"">
...
<script type="text/javascript" src= "{{asset('siteweb/plugin/contact-form/jquery.contactForm.js')}}"></script>
